<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SOS.aspx.cs" Inherits="Member_SOS" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table style="width: 81%; font-size: 10pt; font-family: Verdana;" border="1">
        <tr>
            <td colspan="2">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/BANK IMAGES/Blood Requisite(SOS).jpg" /></td>
        </tr>
        <tr>
            <td style="width: 214px; height: 29px; text-align: justify;">
     ...
     <tr>
         <td style="width: 214px; height: 28px; text-align: justify">
             <asp:Label ID="Label5" runat="server" Text="Residance:"></asp:Label></td>
         <td style="height: 28px">
                <asp:TextBox ID="txtph_resi" runat="server" OnTextChanged="txtph_resi_TextChanged" MaxLength="15"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtph_resi"
     ...
     <tr style="color: #000000">
         <td style="width: 214px; height: 27px; text-align: justify">
             <asp:Label ID="lblpname" runat="server" Text="Patient's Name:"></asp:Label></td>
         <td style="height: 27px">
             <asp:TextBox ID="txtpname" runat="server" MaxLength="40" Width="282px"></asp:TextBox><asp:RequiredFieldValidator
                 ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtpname" ErrorMessage="Name must Be Specified">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator
                     ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtpname"
                     ErrorMessage="Name must be Alphabet. " Height="5px" SetFocusOnError="True" ValidationExpression='[A-Za-z" "]{1,}'
                     Width="10px">*</asp:RegularExpressionValidator></td>
     </tr>
        <tr style="color: #000000">
            <td style="width: 214px; height: 27px; text-align: justify;">
        ...
        <tr>
            <td style="width: 214px; height: 31px; text-align: justify;">
     ...
     <tr>
         <td style="width: 214px; height: 31px; text-align: justify">
             <asp:Label ID="Label8" runat="server" Text="BloodRequire Within :"></asp:Label></td>
         <td style="height: 31px">
             <asp:DropDownList ID="lstrequire" runat="server">
                 <asp:ListItem>24 hrs.</asp:ListItem>
                 <asp:ListItem>48 hrs.</asp:ListItem>
                 <asp:ListItem>72 hrs.</asp:ListItem>
        ...
        <tr>
            <td style="width: 214px; height: 20px; text-align: justify;">
        ...
        <tr>
            <td style="width: 214px; height: 23px; text-align: justify;">
